...
Future<bool> removeCourse(String semester, int order, int sectionId) async {
  ...
  var url = Uri.parse(
      'http://augustapp.one/timetables/$semester/$order/sections/$sectionId/');
...
Future<bool> addCourses(
  ...
  var url =
      Uri.parse('http://augustapp.one/timetables/$semester/$order/sections/');
...
Future<bool> reorderTimetable(String semester, List<int?> order) async {
  ...
  var url = Uri.parse('http://augustapp.one/timetables/$semester/reorder/');
