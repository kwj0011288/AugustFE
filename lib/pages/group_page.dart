...
import 'package:august/pages/group_search_page.dart';
import 'package:august/pages/wizard_page.dart';
import 'package:colorful_safe_area/colorful_safe_area.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import '../get_api/class.dart';
import '../get_api/add_course_to_group.dart';
...
class _GroupPageState extends State<GroupPage> {
  ...
  Future<void> loadSemesterInfo() async {
    ...
    if (storedSemester != null) {
      // 데이터를 상태 변수에 저장하고 UI를 업데이트합니다.
      setState(() {
        // 여기서 _semester는 이 페이지의 상태 변수입니다.
  ...
  Widget build(BuildContext context) {
    ...
    //       if (section.meetings == null || section.meetings!.isEmpty) {
    //         return false;
    //       }
    //     }
    //   }
              ...
              builder: (BuildContext context,
                ...
                return GestureDetector(
                  ...
                  child: GroupSearchPage(
                    ...
                    semester: getOriginalSemester(_semester!),
                  ),
                );
              },
            ),
