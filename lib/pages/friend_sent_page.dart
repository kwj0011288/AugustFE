...
class FriendsSentPage extends StatefulWidget {
  const FriendsSentPage({super.key});

  @override
  State<FriendsSentPage> createState() => _FriendsSentPageState();
}

class _FriendsSentPageState extends State<FriendsSentPage> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Center(
                  child: Text(
                    'Do not hesitate to cancel friend requests tha you sent.',
                    style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.normal,
                        color: Colors.grey),
